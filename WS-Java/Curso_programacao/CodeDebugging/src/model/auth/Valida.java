...
public class Valida {
    public static ArrayList<Integer> cpf(String cpf, Scanner SCANNER){
...

        {
            ...
            System.out.println("primeiro digito: " + primeiro_digito);
            System.out.println("segundo digito: " + segundo_digito);
            System.out.println(" 1 digito " + digito_1);
            System.out.println(" 2 digito " + digito_2);
